...
/*
هذا الكود يمثل تنفيذ لمكدس باستخدام مصفوفة. يوفر الكود وظائف أساسية للمكدس مثل push, pop, top, isEmpty, size, بالإضافة إلى وظائف أخرى خاصة مثل bottom, popBottom, topSecond, popSecond, reverse, و clone
 */